...
// uncomment following lines to enable extra-bar (there are more codes to uncomment if you want to use extra-bar)
...
// uncomment following line(s) to enable extra-bar (there are more codes to uncomment if you want to use extra-bar)
...
updatebars(void)
{
	...
	for (m = mons; m; m = m->next) {
// uncomment following lines to enable extra-bar (there are more codes to uncomment if you want to use extra-bar)
// and uncomment following four uncommented lines (scroll down)
////////////////////// EXTRA-BAR-WIN -start
//		if (!m->barwin) {
